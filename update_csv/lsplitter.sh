...
time SHELL=/bin/bash parallel ${parallel_options} doit1 ::: {-180..179} #minlon

echo "Starting phase 2..."

export -f doit2 # see http://stackoverflow.com/a/26702789
time SHELL=/bin/bash parallel ${parallel_options} doit2 ::: {-90..89} ::: {-180..179} # minlat, minlon (changing this order will make things slower)
